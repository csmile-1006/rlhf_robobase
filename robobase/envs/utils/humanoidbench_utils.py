...
""",
    "h1-run-v0": "The H1 humanoid robot should run forward at 5m/s speed. The running motion should be stable, energy-efficient, and closely resemble natural human running.",
